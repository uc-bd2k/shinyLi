...
var margins = [60, 40, 75, 100];

//var width = 600 - margins[1] - margins[3];

var width = 350 - margins[1] - margins[3];
...
(function () {
  ...
  graph0.append("g")
      ...
      .text("Cell population over time at")
...
(function () {
  ...
  graph.append("g")
      ...
      .text("Cell count normalized to untreated")
...
(function () {
  ...
  graph2.append("g")
      ...
      .text("Normalized growth rate inhibition")
